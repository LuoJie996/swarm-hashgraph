...
def restartSwirlds(threadName):
	...
	os.system("ps auxww | grep 'swirld_black_white_ratio_estimate.py' | awk '{print $2}' | xargs kill -9")
	os.system("python3 swirld_black_white_ratio_estimate.py") # block here
	print("#######################################")
